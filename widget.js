  ...
  STMBLPN.collectBadgeData = function() {
    try {
      ...
      var params = {
        ...
        'utmt': 'event',
        'utmr': 'https://web.archive.org/web/20180802222617/http://www.stumbleupon.com/refer.php',
  ...
  (function() {
      ...
      STMBLPN.Widget.sendBadgeData = function() {
        try {
          ...
          if (!data)
            return;
          top.postMessage(data, 'https://web.archive.org/web/20180802222617/http://www.stumbleupon.com/');
        } catch (e){ }
      };
...
/*
     FILE ARCHIVED ON 22:26:17 Aug 02, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:34:59 Aug 06, 2018.
...
/*
playback timings (ms):
  LoadShardBlock: 1518.341 (18)
  esindex: 0.039 (5)
  CDXLines.iter: 203.18 (12)
  PetaboxLoader3.datanode: 1402.37 (19)
  exclusion.robots: 1.017 (5)
  exclusion.robots.policy: 0.934 (5)
  RedisCDXSource: 9.768 (5)
  PetaboxLoader3.resolve: 66.307
  load_resource: 72.127
*/